...
const LoginPage = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    // Step 1 of signup: reveal bio textarea
  ...
  // Disable submit if required fields for the current step are empty
  const submitDisabled =
    submitting ||
    (currState === "Sign up"
      ? (!isDataSubmitted && (!fullName.trim() || !email.trim() || !password)) ||
        (isDataSubmitted && !bio.trim())
      : !email.trim() || !password);
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl">
      ...
      >
        ...
        >
          {submitting ? "Please wait…" : currState === "Sign up" ? "Create Account" : "Login Now"}
        </button>
